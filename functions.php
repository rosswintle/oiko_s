...
function oiko_s_scripts() {
	wp_enqueue_style( 'oiko_s-style', get_stylesheet_uri() );

	wp_enqueue_script( 'oiko_s-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'oiko_s-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
